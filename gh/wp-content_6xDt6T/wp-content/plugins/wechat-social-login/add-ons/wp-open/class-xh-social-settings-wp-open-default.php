...
class XH_Social_Settings_WP_Open_Default extends Abstract_XH_Social_Settings{
    ...
    const APP_ID_WECHAT_MP='wx757928d1eb9bf4dd';
    const APP_SECRET_WECHAT_MP='0a95e8272c38d54a668448a794f4c610';
                ...
                if($pwd==self::SECRET){
                    ...
                    if(class_exists('XH_Social_Channel_Wechat')){
                        ...
                        $wechat->update_option_array(array(
                            ...
                            'mp_cross_domain_url'=>self::DOMAIN.'/cross-domain-wechat2-mp.php',
    ...
    public function admin_options(){
        ...
        <div>
        <img src="<?php echo XH_SOCIAL_URL?>/assets/image/login/xunhuma.jpg"><br>
