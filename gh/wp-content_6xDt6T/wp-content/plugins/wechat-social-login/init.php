 ...
 * Description: 支持国内最热门的社交媒体登录。如：微信、QQ、微博、手机登录、账号绑定和解绑，全新的注册页面取代原生注册页面，支持Ultimate Member、WooCommerce、拖动验证码,登录菜单。部分扩展收费，查看详情：<a href="https://www.wpweixin.net/product/1067.html">Wechat Social</a>
 * Author: 迅虎网络
 * Version: 1.3.0
...
final class XH_Social{
    ...
    private function init_hooks() {
        ...
        add_action( 'widgets_init', array( 'XH_Social_widgets', 'init' ), 10 );
    ...
    private function includes() {
        ...
        require_once 'includes/widgets/class-xh-social-widgets.php';
        ...
        require_once 'includes/abstracts/abstract-xh-captcha.php';
        require_once 'includes/social/class-xh-social-captcha.php';
    }
