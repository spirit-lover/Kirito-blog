...
global $wp_query;
$url =  $is_home?home_url('/'):( $wp_query->post?get_permalink($wp_query->post):home_url('/'));
?>
<script type="text/javascript">
	if(typeof window.xh_social_share!='function'){
		window.xh_social_share=function(settings){
			...
			var url = encodeURIComponent('<?php echo esc_url_raw(apply_filters('wsocial_share_url', $url))?>');
